...
const BedikahForm = ({ close, dateClicked }: Props) => {
  ...
  if (activeCycles.length === 0) {
    return (
      <Stack align="center" justify="center" w="90%" mx="auto" py={20}>
        <p>
          No cycles in Shiva Nekiyim found. Please add a Hefsek Tahara and start Shiva Nekiyim
          first.
        </p>
      </Stack>
    );
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <Stack align="center" justify="center" w="90%" mx="auto">
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <Radio.Group label="Time of Day" required {...field}>
              <Stack mt="xs">
