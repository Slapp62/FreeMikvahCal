    ...
    <>
      ...
      >
        <Tabs defaultValue="period">
          <Tabs.List mb={10}>
            <Tabs.Tab value="period">Period Start</Tabs.Tab>
            <Tabs.Tab value="hefsek">Hefsek Tahara</Tabs.Tab>
            <Tabs.Tab value="bedikah">Bedikah</Tabs.Tab>
            <Tabs.Tab value="other">Other</Tabs.Tab>
          </Tabs.List>

          <Tabs.Panel value="period" pt="xs">
            <PeriodStartForm close={close} dateClicked={dateClicked} />
          </Tabs.Panel>

          <Tabs.Panel value="hefsek" pt="xs">
            <HefsekTaharaForm close={close} dateClicked={dateClicked} />
          </Tabs.Panel>

          <Tabs.Panel value="bedikah" pt="xs">
            <BedikahForm close={close} dateClicked={dateClicked} />
          </Tabs.Panel>

          <Tabs.Panel value="other" pt="xs">
            <OtherEventForm close={close} />
          </Tabs.Panel>
        </Tabs>
      </Modal>
    </>
