  ...
  return (
    <Box>
      ...
      <Box
        ...
        style={{
          background:
            'linear-gradient(135deg, var(--mantine-color-pink-3) 0%, var(--mantine-color-purple-3) 100%)',
        }}
      >
        <Container size="lg">
          <Stack align="center" gap="xl">
            ...
            <Text size="xl" ta="center" c="pink.9" maw={700}>
              Automatically calculate halachic dates, track your cycle, and receive reminders — all
              customized to your minhagim. 100% free, forever.
            </Text>
            <Group gap="md" mt="md">
              <Button
                component={Link}
        ...
        <SimpleGrid cols={{ base: 1, sm: 2, md: 3 }} spacing="xl">
          <Card shadow="sm" padding="xl" radius="md">
            <Stack align="center" gap="md">
              ...
              <Text size="sm" c="dimmed" ta="center">
                Automatically calculate hefsek tahara, shiva nekiyim, mikvah dates, and vest onahs
                based on halacha
              </Text>
            </Stack>
          </Card>
          ...
          <Card shadow="sm" padding="xl" radius="md">
            <Stack align="center" gap="md">
              ...
              <Text size="sm" c="dimmed" ta="center">
                Never miss an important date with optional email notifications for upcoming events
              </Text>
            </Stack>
          </Card>
          ...
          <Card shadow="sm" padding="xl" radius="md">
            <Stack align="center" gap="md">
              ...
              <Text size="sm" c="dimmed" ta="center">
                Customize calculations for Ashkenazi, Sephardi, Teimani traditions and special onahs
              </Text>
            </Stack>
          </Card>
          ...
          <Card shadow="sm" padding="xl" radius="md">
            <Stack align="center" gap="md">
              ...
              <Text size="sm" c="dimmed" ta="center">
                Accurate calculations based on your location and timezone, anywhere in the world
              </Text>
            </Stack>
          </Card>
          ...
          <Card shadow="sm" padding="xl" radius="md">
            <Stack align="center" gap="md">
              ...
              <Text size="sm" c="dimmed" ta="center">
                No hidden fees, no premium tiers, no paywalls. All features are completely free
                forever
              </Text>
            </Stack>
          </Card>
        ...
        <Grid gutter="xl" align="center">
          <Grid.Col span={{ base: 12, md: 6 }}>
            <Stack gap="lg">
              ...
              <Text size="lg" c="dimmed">
                ...
                different halachic practices. Customize calculations for Ashkenazi, Sephardi, or
                Teimani traditions, plus special onahs like Onat Ohr Zarua.
              </Text>
            </Stack>
          </Grid.Col>
          <Grid.Col span={{ base: 12, md: 6 }}>
            <Box
              ...
              style={{
                background:
                  'linear-gradient(135deg, var(--mantine-color-purple-1) 0%, var(--mantine-color-pink-1) 100%)',
          ...
          <Grid.Col span={{ base: 12, md: 6 }} order={{ base: 2, md: 1 }}>
            <Box
              ...
              style={{
                background:
                  'linear-gradient(135deg, var(--mantine-color-pink-1) 0%, var(--mantine-color-indigo-1) 100%)',
                borderRadius: 'var(--mantine-radius-md)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
          ...
          <Grid.Col span={{ base: 12, md: 6 }} order={{ base: 1, md: 2 }}>
            <Stack gap="lg">
              ...
              <Text size="lg" c="dimmed">
                We take your privacy seriously. Your personal health data is encrypted and stored
                securely. We only collect what's necessary (location for timezone) and never share
      ...
      <Box
        ...
        style={{
          background:
            'linear-gradient(135deg, var(--mantine-color-purple-6) 0%, var(--mantine-color-indigo-6) 100%)',
        }}
      >
        <Container size="md">
          <Stack align="center" gap="xl">
