  ...
  return (
    <Container size="sm" py={40}>
      ...
      <Alert icon={<IconInfoCircle size={16} />} color="blue" mb={20}>
        These stringencies will automatically apply to all new cycles you create. Existing cycles
        ...
        <Stack gap="lg">
          <div>
            <Checkbox
              ...
              checked={ohrZaruah}
              onChange={(event) => setOhrZaruah(event.currentTarget.checked)}
            />
            <Text size="xs" c="dimmed" mt={5} ml={28}>
              Example: If your period started during the day, you would also separate the night
              before each veset.
            </Text>
          </div>
          ...
          <div>
            <Checkbox
              ...
              onChange={(event) => setKreisiUpleisi(event.currentTarget.checked)}
            />
            <Text size="xs" c="dimmed" mt={5} ml={28}>
          ...
          <Button onClick={handleSave} loading={loading} color="pink" fullWidth mt="md">
            Save Preferences
          </Button>
        </Stack>
      </Paper>
