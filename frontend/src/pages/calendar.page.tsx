...
export default function CalendarPage() {
  ...
  const handleDateClick = (arg: DateClickArg) => {
    const date = arg.date;
    const dateClicked = new Date(Date.UTC(date.getFullYear(), date.getMonth(), date.getDate()))
      .toISOString()
      .split('T')[0];
  ...
  return (
    <Stack
      ...
      justify="center"
    >
      <Title order={1} mt={10} ta="center">
        Mikvah Calendar
      </Title>
      <Text fw={500} fz={isMobile ? 'lg' : 'xl'}>
        Click on a day to enter a new event. Click on an existing event to edit it.
      </Text>
      ...
      <FullCalendar
        ...
        dayCellContent={(arg) => {
          ...
          return (
            ...
            >
              <Text className="gregorian-number" style={{ flex: '0 0 auto' }}>
                {arg.dayNumberText}
              </Text>
              <Text
