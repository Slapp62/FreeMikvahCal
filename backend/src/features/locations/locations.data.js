...
const searchLocations = (query = '') => {
  ...
  return locations.filter(loc => {
    const cityMatch = loc.value.toLowerCase().includes(searchTerm);
    const countryMatch = loc.country.toLowerCase().includes(searchTerm);
    const stateMatch = loc.state && loc.state.toLowerCase().includes(searchTerm);
